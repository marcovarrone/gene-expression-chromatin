...
def main(args):
    ...
    if not os.path.exists('../../data/{}/chr_sizes.npy'.format(args.dataset)) or \
    ...
    if args.save_plot and not os.path.exists('../../plots/{}/coexpression/coexpression_chr_{}_{}.png'.format(args.dataset, chr_src, chr_tgt)):
