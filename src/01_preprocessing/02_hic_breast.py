...
if __name__ == '__main__':
    ...
    parser.add_argument('--input', type=str, required=True,
                        help='Name of the Hi-C matrices in .matrix format with "{}" instead of the number of the chromosome, e.g. ../../data/hic_data_chr{}.matrix')
    ...
    dataset_path = '../../data/{}/primary_observed_ICE'.format(args.dataset)
