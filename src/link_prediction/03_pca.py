...
if __name__ == '__main__':
    ...
    hic = np.load('data/GM19238/interactions/interactions_{}.npy'.format(args.interactions))
    ...
    np.save('embeddings/pca/{}_es{}.npy'.format(args.interactions,  args.n_components), embeddings)
